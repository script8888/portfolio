  ...
  return (
    <div>
      ...
      <Head>
        ...
        <meta
          name="description"
          content="Mobiele is a super cool platform based in Africa where you can play mobile games, join tournaments, connect with other gamers, and even win prizes! It's all about gaming fun and competition"
        />
