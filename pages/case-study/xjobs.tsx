	...
	return (
        ...
        `}
			...
			<Head>
				...
				<meta name="description" content="XJobs is a web app that helps freelancers and clients connect and securely handle payments with the latest web3 technology for a smooth and safe onboarding process." />
